...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        UserBean1Dao.createTable(db, ifNotExists);
        UserBean3Dao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        UserBean1Dao.dropTable(db, ifExists);
        UserBean3Dao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(UserBean1Dao.class);
        registerDaoClass(UserBean3Dao.class);
    }
